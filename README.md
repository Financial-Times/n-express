...
For an example set of health check results, see [ft-next-health-eu.herokuapp.com/__health](https://ft-next-health-eu.herokuapp.com/__health). For testing health checks, the [Health Status Formatter extension for Google Chrome](https://github.com/triblondon/health-status-formatter) is recommended.
...
https://ft-next-health-eu.herokuapp.ft.com/__health.2 would return HTTP status 500
https://ft-next-health-eu.herokuapp.ft.com/__health.3 would return HTTP status 500
