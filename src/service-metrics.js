...
var serviceMatchers = {
	...
	'aws-elastic-v1-article': /^https?:\/\/[\w\-]+\.[a-z-0-9]+\.es\.amazonaws\.com\/v1_api_v2\/item/,
	'aws-elastic-v2-article': /^https?:\/\/[\w\-]+\.[a-z-0-9]+\.es\.amazonaws\.com\/v2_api_v[12]\/item/,
	'aws-elastic-v1-item-search': /^https?:\/\/[\w\-]+\.[a-z-0-9]+\.es\.amazonaws\.com\/v1_api_v2\/item\/_search/,
	'aws-elastic-v2-item-search': /^https:\/\/[\w\-]+\.[a-z-0-9]+\.es\.amazonaws\.com\/v2_api_v2\/item\/_search/,
	'aws-elastic-v1-search': /^https?:\/\/[\w\-]+\.[a-z-0-9]+\.es\.amazonaws\.com\/v1_api_v2\/_search/,
	'aws-elastic-v2-search': /^https:\/\/[\w\-]+\.[a-z-0-9]+\.es\.amazonaws\.com\/v2_api_v2\/_search/,
